...
///
/// ## Description
/// `BoundaryConditions` is a struct that stores the boundary conditions (BCs)
/// for a boundary value problem (BVP). Currently, only Dirichlet BCs are
/// supported, and support for more BCs will be implemented in the future.
///
